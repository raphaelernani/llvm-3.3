...
llvm::Value* llvm::OpNode::getOperation() {
        return inst;
}
...
int llvm::DepGraph::getNumBackNodes(){
...
void llvm::DepGraph::removeBackNodes(){
...
void llvm::DepGraph::unifyBackEdges() {
...
std::set<std::pair<GraphNode*, GraphNode*> > llvm::DepGraph::getBackEdges(){
